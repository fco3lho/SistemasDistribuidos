            ...
            <center>
                <table border="1">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="radavatar" value="images/avatar1.png">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="radcor" value="navy" checked>
                            <font color="navy"> Azul </font>
                            
                            <input type="radio" name="radcor" value="red" checked>
                            <font color="red"> Vermelho </font>
                            
                            <input type="radio" name="radcor" value="yellow" checked>
                            <font color="yellow"> Amarelo </font>
                            
                            <input type="radio" name="radcor" value="green" checked>
                            <font color="green"> Verde </font>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center"><input type="submit" name="btncmd" value="Entrar"
